    ...
    if(fichier)  // si l'ouverture a réussi
        {
			...
			Enregistrement* enregistrement = new Enregistrement(aId, aAlbedo, aFluxLum, identifiantCollecteur, aTypeAmpoule, aTypeLampadaire, aHauteur, aLatitude,  aLongitude, aAltitude, aNbImages, aAgglo, aRue, aUlor, aDate, aNotes, puissance);
