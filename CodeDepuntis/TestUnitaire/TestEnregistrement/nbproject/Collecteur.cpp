...
//#include "../../pi/cgicc-3.2.16/cgicc/CgiDefs.h"
//#include "../../pi/cgicc-3.2.16/cgicc/Cgicc.h"
//#include "../../pi/cgicc-3.2.16/cgicc/HTTPHTMLHeader.h"
//#include "../../pi/cgicc-3.2.16/cgicc/HTMLClasses.h"
//#include "../../pi/cgicc-3.2.16/cgicc/CgiEnvironment.h"
//#include "../../pi/cgicc-3.2.16/cgicc/FormEntry.h"
...
//    BDD * laBDD = new BDD();
//    laBDD->modifierEnregistrement(identifiantE, power, albedo, fluxLum, aDonnee->getBuboID(), lamp, streetlight,height, atof(latitude), atof(longitude), atoi(altitude), nbimages, town, aDonnee->getRue(), ULOR, laDate, leHeure, notes);
  //  if (!listeEnregistrements.empty()) {
