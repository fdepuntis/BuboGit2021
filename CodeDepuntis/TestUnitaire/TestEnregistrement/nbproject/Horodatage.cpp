...
void Horodatage::setHeure(char leHeure[6]){
	for (int i=0;i<6;i++)
	{
		heure[i]=leHeure[i];
	}
        cout<<"setHeure : "<<heure<<endl; //on affiche l'attribut heure pour verifier que tout se passe bien
}
