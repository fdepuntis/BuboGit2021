...
${OBJECTDIR}/_ext/5c0/Error.o: ../Error.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Error.o ../Error.cpp
...
${OBJECTDIR}/_ext/5c0/GPSError.o: ../GPSError.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/GPSError.o ../GPSError.cpp
...
${OBJECTDIR}/_ext/5c0/LumError.o: ../LumError.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/LumError.o ../LumError.cpp
...
${OBJECTDIR}/_ext/5c0/Serveur.o: ../Serveur.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Serveur.o ../Serveur.cpp
...
${OBJECTDIR}/_ext/5c0/envoyerBDD.o: ../envoyerBDD.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/envoyerBDD.o ../envoyerBDD.cpp
